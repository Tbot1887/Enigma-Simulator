...
namespace EnigmaSim_CS
{
    class Rotor
    {
        ...
        //Constructor
        public Rotor(int pRotorNumber, int pRotorPos)
        {
            RotorNum = pRotorNumber;
            RotorPos = pRotorPos;
        ...
        public int RunThrough(int input, bool isForward)
        {
            int output = 0;
        ...
        //Rotor Name Properties
        public string RotorName
        {
            get
            {
                return name[RotorNum];
            }
        }
    }
}
